({
    sortBy: function(field, reverse, primer) {
        ...
        return function(a, b) {
            ...
            if(a == undefined){ //if the first value is undefined
                return reverse;
            }
            if(b == undefined){ //if the first value is undefined
                return reverse * -1;
            }
    ...
    loadDataTable: function (cmp, event, help) {
        ...
        if(cmp.get('v.objectRecordIdsList') == null){
            cmp.set('v.objectRecordIdsList', []);
        }
        ...
        action.setParams({
            ...
            'objectRecordIdsList' : cmp.get('v.objectRecordIdsList')
        }); 
        ...
        action.setCallback(this, $A.getCallback(function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                if(result){
                    ...
                    this.setNumberOfItems(cmp, result['lstObject'].length);
